...
def downgrade():
    ...
    op.create_foreign_key('user_group_member_user_group_id_fkey', 'user_group_member', 'user_group', ['user_group_id'],
                          ['id'])
    ...
    op.create_foreign_key('unconfigured_device_device_group_id_fkey', 'unconfigured_device', 'device_group',
                          ['device_group_id'], ['id'])
    op.drop_constraint(None, 'state_enumerator', type_='foreignkey')
    op.create_foreign_key('state_enumerator_executive_type_id_fkey', 'state_enumerator', 'executive_type',
                          ['executive_type_id'], ['id'])
    op.drop_constraint(None, 'sensor_type', type_='foreignkey')
    op.create_foreign_key('sensor_type_device_group_id_fkey', 'sensor_type', 'device_group', ['device_group_id'],
                          ['id'])
    ...
    op.create_foreign_key('reading_enumerator_sensor_type_id_fkey', 'reading_enumerator', 'sensor_type',
                          ['sensor_type_id'], ['id'])
    ...
    op.create_foreign_key('executive_type_device_group_id_fkey', 'executive_type', 'device_group', ['device_group_id'],
                          ['id'])
    op.drop_constraint(None, 'executive_device', type_='foreignkey')
    op.drop_constraint(None, 'executive_device', type_='foreignkey')
    op.drop_constraint(None, 'executive_device', type_='foreignkey')
    op.drop_constraint(None, 'executive_device', type_='foreignkey')
    op.create_foreign_key('executive_device_executive_type_id_fkey', 'executive_device', 'executive_type',
                          ['executive_type_id'], ['id'])
    op.create_foreign_key('executive_device_formula_id_fkey', 'executive_device', 'formula', ['formula_id'], ['id'])
    op.create_foreign_key('executive_device_user_group_id_fkey', 'executive_device', 'user_group', ['user_group_id'],
                          ['id'])
    op.create_foreign_key('executive_device_device_group_id_fkey', 'executive_device', 'device_group',
                          ['device_group_id'], ['id'])
